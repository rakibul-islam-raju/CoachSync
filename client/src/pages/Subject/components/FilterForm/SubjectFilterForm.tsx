...
import { subjectOrderings } from "../../../../constants/subject.constants";
import { useAppDispatch, useAppSelector } from "../../../../redux/hook";
import { ISubjectParams } from "../../../../redux/subject/subject.type";
import { resetParams, setParams } from "../../../../redux/subject/subjectSlice";

const SubjectFilterForm: FC = () => {
  const dispatch = useAppDispatch();
  const { params } = useAppSelector(state => state.subject);

  const [args, setArgs] = useState<Partial<ISubjectParams> | null>(params);
